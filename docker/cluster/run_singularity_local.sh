...
export PATH=/gpfslocalsys/singularity/singularity-3.8.5/bin:$PATH
...
source $SCRIPT_DIR/.env_local.cluster
...
echo "This is the .sif file path: ${TMPDIR}/${2}.sif"
...
singularity exec \
    ...
    --nv --containall --writable ${TMPDIR}/${2}.sif \
    bash -c "export ISAACLAB_PATH=/workspace/isaaclab && cd /workspace/isaaclab && /isaac-sim/python.sh ${CLUSTER_PYTHON_EXECUTABLE} --task Isaac-Velocity-Rough-Anymal-C-v0 --headless --video --enable_cameras"
